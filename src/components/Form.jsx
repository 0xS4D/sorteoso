...
export default function Form() {
  ...
  return (
    <div className='relative bg-[#ffffff11] backdrop-blur-md border-[5px] h-[55%] border-orange-500 w-full sm:h-auto sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 rounded-3xl p-5 flex flex-col items-center justify-between'>
      ...
      <div className='flex flex-col items-center h-full space-y-2 pt-10'>
